...
public class TransformDisplay {
    ...
    public GridPane splitDisplay() {
        ...
        TableView<Integer> datasetTable = displayTable(transform.getDataTable());
                        ...
                        public void handle(WindowEvent we) {
                            if (transform.getSave()) {
                                ...
                                button1.setOnAction(new EventHandler<ActionEvent>() {
                                    @Override
                                    public void handle(ActionEvent e) {
                                        transform.setDc(newTables[1].getDc());
                                        stage.hide();
                                    }
                                });
            ...
            public void handle(ActionEvent e) {
                try {
                    ...
                    stage.setOnHiding(new EventHandler<WindowEvent>() {
                        public void handle(WindowEvent we) {
                            if (transform.getSave()) {
                                transform.setDc(tempTable);
                            }
                            else {
                                DataTable newTable = new DataTable();
                                newTable.setDc(tempTable);
